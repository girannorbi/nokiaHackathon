with open('./input.txt', 'r') as f:
  ...
  for line in input:
    ...
    for offset in range(len(line)):
      if line[offset] != line[len(line)-1 - offset] and isPalindrome: # checks if the carachter from the front is equals to the character in the back, while moving inside
        isPalindrome = False
